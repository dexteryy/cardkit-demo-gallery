...
if (typeof module === 'undefined' 
    ...
    define = function(mid, deps, factory){
        var exports = ((this.mo || (this.mo = {})).lang 
            || (this.mo.lang = {})).mix = {};
        factory(null, this.mo.lang.type, null, exports);
    };
}
define("mo/lang/mix", [
  "mo/lang/es5",
...
/* @source mo/lang/es6-collection.js */;
...
define("prism", [], function(require, exports, module){
...
/* @source ../galleryapp/spec/codebox.js */;


define("../galleryapp/spec/codebox", [
  "dollar",
  "prism"
], function($, Prism){
...
/* @source ../galleryapp/oldspec/codebox.js */;


define("../galleryapp/oldspec/codebox", [
  "dollar",
  "prism",
...
/* @source ../galleryapp/tpl/codebox.js */;

define("../galleryapp/tpl/codebox", [], function(){

    return {"template":"<div class=\"ck-folder\"\n        data-enable-label=\"Hide the {%= state.langName %}\"\n        data-label=\"header\">\n    <header>Show the {%= state.langName %}</header>\n    <div class=\"content democode\"><pre class=\"language-ck\"><code class=\"language-ck\">{%= state.code %}</code></pre></div>\n</div>\n"}; 
...
/* @source ../galleryapp/component/codebox.js */;


define("../galleryapp/component/codebox", [
  "darkdom",
  "mo/template/micro",
  "../galleryapp/tpl/codebox"
